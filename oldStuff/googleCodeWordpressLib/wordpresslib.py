...
class WordPressPost:
	...
	def __str__(self):
		...
		s += "\ntitle: %s" %self.title
		s += "\ndate: %s" %self.date
		s += "\npermaLink: %s" %self.permaLink
		s += "\ndescription: %s" %self.description
		s += "\ntextMore: %s" %self.textMore
		s += "\nexcerpt: %s" %self.excerpt
		s += "\nlink: %s" %self.link
		s += "\ncategories: %s" %self.categories
		s += "\nuser: %s" %self.user
		s += "\nallowPings: %s" %self.allowPings
		s += "\nallowComments: %s" %self.allowComments
		return s
